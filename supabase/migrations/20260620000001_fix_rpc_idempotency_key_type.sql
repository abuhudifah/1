...
BEGIN
  ...
  INSERT INTO public.transactions (
    ...
    NULLIF(p_transaction->>'agent_id',          '')::UUID,
    ...
    NULLIF(p_transaction->>'expense_account_id','')::UUID,
    p_transaction->>'details',
    NULLIF(p_transaction->>'date', '')::DATE,
    NULLIF(p_transaction->>'time', '')::TIME,
    NULLIF(p_transaction->>'from_agent_id',     '')::UUID,
    NULLIF(p_transaction->>'to_agent_id',       '')::UUID,
    NULLIF(p_transaction->>'executed_by',       '')::UUID,
